...
<?php
	$record_pag=2;
		$sqll="select count(*) as cont_record from partecipare where id_disoccupato='". $_SESSION["id"]. "'";
	...
	mysqli_set_charset($conn,"utf8");
		$sql="select c.id_corso, nome, descrizione_breve, foto from partecipare as p, corsi as c where p.id_corso=c.id_corso and id_disoccupato='". $_SESSION["id"]. "' LIMIT $inizio, $record_pag";
...
<div id='fotoutente'>";
echo "<a href = 'lezioni.php?id=" . $riga['id_corso'] . "'><img src='immagini/" . $riga["foto"] . "' width:'90' height:'90'></a></div>
