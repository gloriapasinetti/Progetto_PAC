...
<?php
	...
	mysqli_set_charset($conn,"utf8");
		$sql="select id_corso, nome, descrizione_breve, foto from corsi LIMIT $inizio, $record_pag";
...
<div id='fotoutente'>";
echo "<a href = 'dettaglicorso.php?id=" . $riga['id_corso'] . "'><img src='immagini/" . $riga["foto"] . "' width:'90' height:'90'></a></div>
